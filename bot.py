...
async def cmd_start(message: types.Message) -> None:
    await message.answer('Добро пожаловать! Чтобы создать профиль - введите /create',
                         reply_markup=get_kb())
...
async def cmd_create(message: types.Message) -> None:
    await message.reply("Давайте создадим ваш профиль! Для начала пришлите мне свою фотографию!",
